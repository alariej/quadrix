...
export const LOGO_FILL2 = 'silver';
...
export const TILE_BACKGROUND_OWN = '#eafbfb';
export const TILE_BACKGROUND_SELECTED = '#d9d9d9';
...
export const BUTTON_UNREAD_BACKGROUND = '#FF7B36';
...
export const HEADER_TEXT = '#1a1a1a';
...
export const MARKER_READ_FILL = 'deepskyblue';
export const MARKER_SENT_FILL = 'silver';
