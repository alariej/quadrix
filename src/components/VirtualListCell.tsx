...
export interface VirtualListCellProps<ItemInfo extends VirtualListCellInfo> extends RX.CommonProps {
	...
	onItemSelected?: (item: ItemInfo | undefined) => void;
...
export class VirtualListCell<ItemInfo extends VirtualListCellInfo> extends RX.Component<
	VirtualListCellProps<ItemInfo>,
	RX.Stateless
> {
	...
	componentDidUpdate(_prevProps: VirtualListCellProps<ItemInfo>) {
	...
	render() {
		...
		return (
			<RX.Animated.View
				...
				onKeyPress={typeof this.props.onItemSelected === 'function' ? this._onKeyPress : undefined}
				disableTouchOpacityAnimation={
					this.props.item ? this.props.item.disableTouchOpacityAnimation : undefined
				}
			>
	...
	private _onKeyPress = (e: RX.Types.KeyboardEvent) => {
		const isSelectItemKeyPress =
			e.keyCode === _keyCodeEnter || e.keyCode === _keyCodeSpace || e.keyCode === _keyCodeReturn;
	...
	private _onFocus = (_e: RX.Types.FocusEvent) => {
	...
	private _onBlur = (_e: RX.Types.FocusEvent) => {
		if (this.props.onItemFocused) {
