...
interface CachedImageProps {
    ...
    style: RX.Types.StyleRuleSetRecursive<RX.Types.ImageStyleRuleSet> | RX.Types.StyleRuleSetRecursive<RX.Types.ImageStyleRuleSet>[],
    source: string;
...
export default class CachedImage extends RX.Component<CachedImageProps, RX.Stateless> {
    ...
    constructor(props: CachedImageProps) {
        ...
        this.backgroundColor = this.props.animated && this.props.mimeType === 'image/jpeg' ? UiStore.getAppColor() : undefined;
