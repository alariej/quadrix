...
export const storageAccessMessage: Translation = {
	...
	de:
		APP_NAME +
		' erfordert Speicherzugriff für das Lesen und Schreiben von Dateien auf Ihr mobiles Gerät. Setzen Sie fort zum nächsten Dialog, wo Sie den Speicherzugriff zulassen oder ablehnen können.',
	fr:
		APP_NAME +
		" nécessite l'accès au stockage pour lire et écrire des fichiers sur votre appareil mobile. Continuez au dialogue suivant où vous pouvez choisir d'autoriser ou de refuser l'accès au stockage.",
};
...
export const batteryOptimizationText: Translation = {
	...
	de:
		'Um Push-Benachrichtigungen für neue Nachrichten zu aktivieren, nehmen Sie ' +
		APP_NAME +
	...
	fr:
		...
		APP_NAME +
		" sur la whitelist dans les paramètres d'optimisation de la batterie",
};
