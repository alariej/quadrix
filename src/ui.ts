...
export const TILE_BACKGROUND_OWN = '#D6FFDB';
export const TILE_BACKGROUND_SELECTED = '#E6E6E6';
...
export const HEADER_TEXT = TILE_MESSAGE_TEXT;
export const HEADER_STATUS = 'grey';
