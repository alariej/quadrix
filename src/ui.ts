...
export const BUTTON_MENU_COMPOSER_WIDTH = 160;
...
export const BUTTON_HEADER_WIDTH = 20;
export const BUTTON_HEADER_MARGIN = 16;
...
export const TILE_BACKGROUND_OWN = '#DFFBF2';
...
export const JITSI_BORDER = 'grey';
