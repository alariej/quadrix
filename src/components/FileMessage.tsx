...
import { LINK_TEXT, MODAL_CONTENT_TEXT, FONT_LARGE, FONT_NORMAL, TILE_SYSTEM_TEXT, ICON_INFO_FILL, BUTTON_FILL } from '../ui';
    ...
    private viewFile = (event: RX.Types.SyntheticEvent) => {
            ...
            if (success) {
                ...
                const text = (
                    <RX.Text style={styles.textDialog}>
                        <RX.Text>
                            { fileCouldNotAccess[UiStore.getLanguage()] }
                        </RX.Text>
                    </RX.Text>
                );
        ...
        const onNoAppFound = () => {
            ...
            const text = (
                <RX.Text style={ styles.textDialog }>
                    <RX.Text>
                        { noApplicationWasFound[UiStore.getLanguage()] }
                    </RX.Text>
                </RX.Text>
            );
