...
export const BUTTON_SHORT_WIDTH = 90;
...
export const HEADER_BACKGROUND = 'rgba(0, 0, 0, 0.5)';
...
export const COMPOSER_BORDER = 'rgba(255, 255, 255, 0.2)';
...
export const MARKER_SENT_FILL = 'grey';
